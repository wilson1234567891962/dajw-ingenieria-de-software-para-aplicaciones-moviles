...
import com.example.vinyls_jetpack_application.ui.adapters.ArtistaAdapter
import com.example.vinyls_jetpack_application.viewmodels.ArtistaViewModel
...
class ArtistaFragment : Fragment() {
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        viewModel.albums.observe(viewLifecycleOwner, Observer<List<Artista>> {
            it.apply {
